...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    function parseDocument$1(doc) {
      ...
      var parsed = parse$1(doc, { experimentalFragmentVariables: experimentalFragmentVariables$1 });
      if (!parsed || parsed.kind !== 'Document') {
        throw new Error('Not a valid GraphQL document.');
      }
    ...
    gql$2.default = gql$2;
    gql$2.resetCaches = resetCaches$2;
    gql$2.disableFragmentWarnings = disableFragmentWarnings$2;
    gql$2.enableExperimentalFragmentVariables = enableExperimentalFragmentVariables$2;
    gql$2.disableExperimentalFragmentVariables = disableExperimentalFragmentVariables$2;

    var src = gql$2;

    /* src\LoginForm.svelte generated by Svelte v3.9.1 */
    const { Object: Object_1 } = globals;

    const file = "src\\LoginForm.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(changed, ctx) {
    		if (ctx.isSuccess) return create_if_block;
  ...
  `;
    ...
    function empty$1() {
        return new ApolloLink$1(function () { return Observable.of(); });
    }
    function from(links) {
        if (links.length === 0)
            return empty$1();
    ...
    var concat = function (first, second) {
        ...
        if (isTerminating$1(firstLink)) {
            process.env.NODE_ENV === "production" || invariant$2.warn(new LinkError$1("You are calling concat on a terminating link, which will have no effect", firstLink));
            return firstLink;
        }
    ...
    var Observable$1 = (function (_super) {
        ...
        Observable.prototype[result$1] = function () {
            return this;
        };
